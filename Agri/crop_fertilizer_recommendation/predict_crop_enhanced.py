...
def generate_rule_based_explanation(crop, confidence, sample_data, insights):
    """
...
def predict_crop_enhanced(sample_data):
    ...
    try:
        ...
        explanation = generate_rule_based_explanation(crop, confidence, sample_data, insights)
