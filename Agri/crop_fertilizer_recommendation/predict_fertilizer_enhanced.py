...
def generate_rule_based_explanation(fertilizer, confidence, sample_data, insights):
    """
    Generate a natural language explanation for the fertilizer recommendation.
    This uses rule-based logic for generating explanations.
    """
...
def predict_fertilizer_enhanced(sample_data):
    ...
    try:
        ...
        explanation = generate_rule_based_explanation(fertilizer, confidence, sample_data, insights)
